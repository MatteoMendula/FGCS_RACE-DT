...
def get_Hps_folder(asset_name, n_layers):
    HPS_FOLDER = f"./RC_selected_hps/{asset_name}/mlp_aggregated_prediction_step1/" # Kept folder name assuming HPs were derived this way
    return HPS_FOLDER

def getResultsFolder(asset_name):
    RESULTS_FOLDER = f"./time_only/NASA_results_val_selected_hps_{asset_name}/race_free_mlp_aggregated_prediction_val_split_step1/" # Kept folder name assuming HPs were derived this way
